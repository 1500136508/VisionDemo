...
DWORD GetStatusText(AM_DVD_RENDERSTATUS *pStatus, PTSTR pszStatusText, DWORD dwMaxText)
{
    ...
    {
         hr = StringCchPrintf(pszBuff, len,
        ...
        {
            hr = StringCchPrintf(pszBuff, len, TEXT("    - video stream\n")) ;
            if (hr != S_OK)
            {
                return 0;
            }
        ...
        {
            hr = StringCchPrintf(pszBuff, len, TEXT("    - audio stream\n")) ;
            if (hr != S_OK)
            {
                return 0;
            }
        ...
        {
            hr = StringCchPrintf(pszBuff, len, TEXT("    - subpicture stream\n")) ;
            if (hr != S_OK)
            {
                return 0;
            }
    ...
    {
        hr = StringCchCat(pszBuff, len, TEXT("* ")) ;
        if (hr != S_OK)
        {
            return hr;
        }
        size_t t = lstrlen(TEXT("* ")) ;
        iChars = int(t);
        len -= t;

        iChars = AMGetErrorText(pStatus->hrVPEStatus, pszBuff, DWORD(len) ) ;
        pszBuff += iChars ;
        len -= iChars;
    ...
    {
        hr = StringCchPrintf(pszBuff, len, TEXT("* Specified DVD-Video volume was invalid!\n")) ;
        if (hr != S_OK)
        {
            return 0;
        }
    ...
    {
        hr = StringCchPrintf(pszBuff, len, TEXT("* No valid DVD-Video volume could be located!\n")) ;
        if (hr != S_OK)
        {
            return 0;
        }
    ...
    {
        hr = StringCchPrintf(pszBuff, len, TEXT("* The video decoder doesn't produce closed captioning data.\n")) ;
        if (hr != S_OK)
        {
            return 0;
        }
    ...
    {
        hr = StringCchPrintf(pszBuff, len, TEXT("* Decoded closed caption data not rendered properly!\n")) ;
        if (hr != S_OK)
        {
            return 0;
        }
    ...
    DWORD dwLength = DWORD( (pszBuff - szBuffer) * sizeof(*pszBuff) ) ;
    dwLength = min(dwLength, dwMaxText) ;
        hr = StringCchCopy(pszStatusText, dwLength, szBuffer) ;
