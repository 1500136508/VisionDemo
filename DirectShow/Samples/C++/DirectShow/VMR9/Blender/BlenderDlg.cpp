...
BOOL CBlenderDlg::IsWindowsMediaFile(WCHAR *lpszFile)
{
    ...
    (void)StringCchPrintf(szFilename, NUMELMS(szFilename), TEXT("%ls"), lpszFile);
    _tcslwr(szFilename);
...
void CBlenderDlg::DisplayAlpha(int nStreamID)
{
    ...
    HRESULT hr = StringCchPrintfA(szAnsiLabel, NUMELMS(szAnsiLabel), "(%02.2f)\0", strParam[nStreamID].Alpha);
