...
//       Using the Windows XP Video Mixing Renderer, a static image is
        ...
        case WM_COMMAND:
            switch (wParam)
            {
                case IDOK:
                {
                    ...
                    (void)StringCchCopy(g_szAppText, NUMELMS(g_szAppText), szText);
                ...
                case IDCANCEL:
                    ...
                    (void)StringCchCopy(g_szAppText, NUMELMS(g_szAppText), szSaveText);
                    BlendApplicationText(ghApp, g_szAppText);
                    EndDialog(hWnd, TRUE);
                    break;
