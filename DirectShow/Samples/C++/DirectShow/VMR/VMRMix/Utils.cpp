...
//-----------------------------------------------------------------------------------------*/
void GetMessageName(LPTSTR Name, UINT msg, size_t len)
{
    switch(msg)
    {
        // For put_MessageDrain and get_MessageDrain

        case WM_KEYDOWN:           (void)StringCchCopy(Name, len, _T("WM_KEYDOWN\0"));         break;
        case WM_KEYUP:             (void)StringCchCopy(Name, len,  _T("WM_KEYUP\0"));           break;
        case WM_LBUTTONDBLCLK:     (void)StringCchCopy(Name, len,  _T("WM_LBUTTONDBLCLK\0"));   break;
        case WM_LBUTTONDOWN:       (void)StringCchCopy(Name, len,  _T("WM_LBUTTONDOWN\0"));     break;
        case WM_LBUTTONUP:         (void)StringCchCopy(Name, len,  _T("WM_LBUTTONUP\0"));       break;
        case WM_MBUTTONDBLCLK:     (void)StringCchCopy(Name, len,  _T("WM_MBUTTONDBLCLK\0"));   break;
        case WM_MBUTTONDOWN:       (void)StringCchCopy(Name, len,  _T("WM_MBUTTONDOWN\0"));     break;
        case WM_MBUTTONUP:         (void)StringCchCopy(Name, len,  _T("WM_MBUTTONUP\0"));       break;
        case WM_MOUSEACTIVATE:     (void)StringCchCopy(Name, len,  _T("WM_MOUSEACTIVATE\0"));   break;
        case WM_MOUSEMOVE:         (void)StringCchCopy(Name, len,  _T("WM_MOUSEMOVE\0"));       break;
        case WM_NCHITTEST:         (void)StringCchCopy(Name, len,  _T("WM_NCHITTEST\0"));       break;
        case WM_NCLBUTTONDBLCLK:   (void)StringCchCopy(Name, len,  _T("WM_NCLBUTTONDBLCLK\0")); break;
        case WM_NCLBUTTONDOWN:     (void)StringCchCopy(Name, len,  _T("WM_NCLBUTTONDOWN\0"));   break;
        case WM_NCLBUTTONUP:       (void)StringCchCopy(Name, len,  _T("WM_NCLBUTTONUP\0"));     break;
        case WM_NCMBUTTONDBLCLK:   (void)StringCchCopy(Name, len,  _T("WM_NCMBUTTONDBLCLK\0")); break;
        case WM_NCMBUTTONDOWN:     (void)StringCchCopy(Name, len,  _T("WM_NCMBUTTONDOWN\0"));   break;
        case WM_NCMBUTTONUP:       (void)StringCchCopy(Name, len,  _T("WM_NCMBUTTONUP\0"));     break;
        case WM_NCMOUSEMOVE:       (void)StringCchCopy(Name, len,  _T("WM_NCMOUSEMOVE\0"));     break;
        case WM_NCRBUTTONDBLCLK:   (void)StringCchCopy(Name, len,  _T("WM_NCRBUTTONDBLCLK\0")); break;
        case WM_NCRBUTTONDOWN:     (void)StringCchCopy(Name, len,  _T("WM_NCRBUTTONDOWN\0"));   break;
        case WM_NCRBUTTONUP:       (void)StringCchCopy(Name, len,  _T("WM_NCRBUTTONUP\0"));     break;
        case WM_RBUTTONDBLCLK:     (void)StringCchCopy(Name, len,  _T("WM_RBUTTONDBLCLK\0"));   break;
        case WM_RBUTTONDOWN:       (void)StringCchCopy(Name, len,  _T("WM_RBUTTONDOWN\0"));     break;
        case WM_RBUTTONUP:         (void)StringCchCopy(Name, len,  _T("WM_RBUTTONUP\0"));       break;

        // For NotifyOwnerMessage

        case WM_DEVMODECHANGE:     (void)StringCchCopy(Name, len, _T("WM_DEVMODECHANGE\0"));     break;
        case WM_DISPLAYCHANGE:     (void)StringCchCopy(Name, len, _T("WM_DISPLAYCHANGE\0"));     break;
        case WM_MOVE:              (void)StringCchCopy(Name, len, _T("WM_MOVE\0"));              break;
        case WM_PALETTECHANGED:    (void)StringCchCopy(Name, len, _T("WM_PALETTECHANGED\0"));    break;
        case WM_PALETTEISCHANGING: (void)StringCchCopy(Name, len, _T("WM_PALETTEISCHANGING\0")); break;
        case WM_QUERYNEWPALETTE:   (void)StringCchCopy(Name, len, _T("WM_QUERYNEWPALETTE\0"));   break;
        case WM_SYSCOLORCHANGE:    (void)StringCchCopy(Name, len, _T("WM_SYSCOLORCHANGE\0"));    break;

        default:                   (void)StringCchPrintf(Name, len, _T("Unknown Messgage [%u]\0"), msg);
    }
