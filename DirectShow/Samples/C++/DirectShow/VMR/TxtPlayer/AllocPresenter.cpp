    ...
    )
{
    ...
    HRESULT hr = StringCchCopy(lfChar.lfFaceName, NUMELMS(lfChar.lfFaceName),TEXT("Lucida Console\0")) ;
    ...
    // for the font cache.
    //
    hr = DDARGB32SurfaceInit(&m_lpDDSFontCache, TRUE, 16 * size.cx, 6 * size.cy);
