...
void UpdateText(void)
{
    ...
    static TCHAR szText[MAX_TEXT_LINES][80]  = {
        TEXT("Introducing the Video Mixing Renderer,"),
        TEXT("only available on Microsoft Windows XP!"),
        TEXT("The VMR supports multiple video streams"),
        TEXT("and a static bitmap, all of which"),
        TEXT("can be mixed with alpha blending.\0")
    };
...
{ 
    ...
    lstrcpyn(lf.lfFaceName, g_szFontName, NUMELMS(lf.lfFaceName));
