...
// Use bitmaps and audio files known to install with the DirectX SDK
WCHAR * wszVideo1Name = L"dx5_logo.bmp\0";
WCHAR * wszVideo2Name = L"env3.bmp\0";
WCHAR * wszAudio1Name = L"track2.mp3\0";
WCHAR * wszAudio2Name = L"track3.mp3\0";
...
HRESULT DXUtil_GetDXSDKMediaPathCch( TCHAR* strDest, int cchDest )
{
    ...
    (void)StringCchCopy( strDest, cchDest, TEXT("") );
    ...
    if( lstrlen(strDest) + lstrlen(strMedia) < cchDest )
        (void)StringCchCat( strDest, cchDest, strMedia );
    else
        return E_INVALIDARG;
...
int TimelineTest( )
{
    ...
    hr = CoCreateInstance( CLSID_PropertySetter, NULL, CLSCTX_INPROC_SERVER, 
                           IID_IPropertySetter, (void**) &pTransSetter );
    ...
    (void)StringCchCopyW( pClipname, NUMELMS(pClipname), T2W( tBasePath ) );
    (void)StringCchCatW( pClipname, NUMELMS(pClipname), L"\\\0" );
    (void)StringCchCatW( pClipname, NUMELMS(pClipname), wszAudio1Name );
    ...
    memset( &AudioValue[0], 0, sizeof( AudioValue[0] ) );
    ...
    (void)StringCchCopyW( pClipname, NUMELMS(pClipname), T2W( tBasePath ) );
    (void)StringCchCatW( pClipname, NUMELMS(pClipname), L"\\\0" );
    (void)StringCchCatW( pClipname, NUMELMS(pClipname), wszAudio2Name );
    ...
    hr = CoCreateInstance( CLSID_PropertySetter, NULL, CLSCTX_INPROC_SERVER, 
                           IID_IPropertySetter, (void**) &pVolSetter );
