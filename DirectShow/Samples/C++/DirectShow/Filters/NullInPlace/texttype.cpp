                            ...
                            LPTSTR szAtEnd)
{
    ...
    (void)StringCchPrintf(szType, iLen, TEXT("%s%s%s%s%s%s%s%s%s\0"),
                                   ...
                                   ULONG lFormatLength)
{
        ...
        IsEqualGUID(*pFormatType, FORMAT_MPEGVideo)) 
    {
        ...
        (void)StringCchPrintf(szBuffer, iLength, TEXT("%4.4hs %dx%d, %d bits\0")
    ...
    if (IsEqualGUID(*pFormatType, FORMAT_WaveFormatEx)) 
    {
        ...
        (void)StringCchPrintf(szBuffer, iLength, TEXT("%s: %.3f KHz %d bit %s \0")
                   , szName
    ...
    (void)StringCchPrintf(szBuffer, iLength, TEXT("%s\0"), szName);
}
